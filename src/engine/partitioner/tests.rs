//! Purpose: Test suite for the partitioner module.
//! Edit here when: Adding or modifying partitioner tests.
//! Do not edit here for: Production code changes — edit the relevant submodule.
